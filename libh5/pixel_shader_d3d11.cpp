...
namespace h5
{
	pixel_shader_d3d11::pixel_shader_d3d11() {}
	...
	int32_t pixel_shader_d3d11::load(const std::wstring &filename, const std::string &entry_point)
	{
	...
	void pixel_shader_d3d11::terminate()
	{
